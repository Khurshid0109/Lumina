        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudyArea = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Rating = table.Column<float>(type: "real", nullable: false),
                    StartedDay = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ...
                    StudyCenterId = table.Column<long>(type: "bigint", nullable: true),
                    SubjectId = table.Column<long>(type: "bigint", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courses_StudyCenters_StudyCenterId",
                        column: x => x.StudyCenterId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_StudyCenterId",
                table: "Courses",
                column: "StudyCenterId");
